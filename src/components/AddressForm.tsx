            ...
            <div onClick={resetForm} className="fixed inset-0 z-50 flex-center p-4">
                ...
                <form onClick={e => e.stopPropagation()} onSubmit={handleSubmit} className="bg-white rounded-2xl p-6 w-full max-w-lg animate-fade-in">
                    ...
                    <div className="flex items-center justify-between mb-5">
                        <h2 className="text-lg font-semibold text-app-green">{editingId ? "Editing Address" : "Add New Address"}</h2>
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" placeholder="Home, Work , etc" required className="w-full px-4 py-2.5 text-sm rounded-xl border border-app-border focus:border-app-green outline-none" value={form.value} onChange={(e) => setForm({ ...form, label: e.target.value })} />
                    ...
                    <button type="submit" className="mt-6 w-full py-3 bg-app-green text-white font-semibold rounded-xl hover:bg-app-green-light transition-colors">
                        ...
                        {editingId ? "Update Address" : "Save Addreess"}
