...
const Products = () => {
  ...
  const minPrice = searchParams.get("miniPrice") || "";
  ...
  const updataFilter = (key: string, value: string) => {
        ...
        <div className="flex gap-8 xl:gap-10">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            ...
            <div className="bg-white rounded-2xl p-4 sticky top-24">
              ...
              <FilterPanel categories={categoriesData} category={category} organic={organic} miniPrice={minPrice} maxPrice={maxPrice} updateFilter={updataFilter} clearFilters={clearFilters} hashFilters={hashFilters} />
          ...
          <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div>
                ...
                <p className="text-sm text-app-text-light mt-0.5ّ">{products.length} products found</p>

              </div>


              <div className="flex flex-col lg:items-center gap-3ّ">
                ...
                <div className="relative">
                  ...
                  <select value={sort} onChange={(e) => updataFilter('sort', e.target.value)} className="appearance-none pl-3 pr-8 py-2 text-sm bg-white rounded-xl border border-app-border focus:border-app-green outline-none cursor-pointer">
                  ...
                  <ChevronDown className="absolute right-2.5 top-1/2 -translae-y-1/2 w-3.5 h-3.5 text-app-text-light pointer-events-none" />
            ...
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-lg font-semibold text-app-green mb-2">No prodcuts found</p>
                <p className="text-sm text-app-text-light mb-4">Try adjustting your filters or search terms</p>
            ...
            {totalpage > 1 && (
              <div className="flex-center gap-2 mt-16">
                ...
                {Array.from({ length: totalpage }).map((_, i) => (
                  ...
                  <button key={i} onClick={() => { updataFilter("page", String(i + 1)); scrollTo(0, 0) }} className={`size-9 rounded-lg text-sm font-medium transition-colors ${page === i + 1 ? "bg-app-green text-white" : "bg-white text-app-text-light hover:bg-app-cream"}`}>
      ...
      {mobileFiltersOpen && (
        <>
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80vh] overflow-y-auto animate-slide-in-up">
            ...
            <div className="fixed items-center justify-between p-4 border-b border-app-border">
